---
name: canvas
description: Display HTML content on connected OpenClaw nodes (Mac app, iOS, Android). Use when presenting web content, games, visualizations, or dashboards on a node's canvas view.
